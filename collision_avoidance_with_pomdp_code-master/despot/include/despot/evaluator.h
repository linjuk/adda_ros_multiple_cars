...
#include "../../examples/cpp_models/car/include/util/Printer.h"
...
public:
	...
	Evaluator(Car* model, std::string belief_type, Solver* solver,
	...
	virtual void ReportStepReward(Printer printer);
