...
if("TRUE" STREQUAL "TRUE")
  set(despot_SOURCE_PREFIX /home/albert/ias_ros/src/despot/examples/cpp_models/car)
  set(despot_DEVEL_PREFIX /home/albert/ias_ros/src/despot/cmake-build-debug/devel)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'Albert Schotschneider <albert.schotschneider@stud.tu-darmstadt.de>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'despot' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'despot' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/albert/ias_ros/src/despot/examples/cpp_models/car/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/albert/ias_ros/src/despot/cmake-build-debug/devel/lib;/home/albert/ias_ros/devel/lib;/opt/ros/kinetic/lib)
...
set(depends "roscpp;std_msgs;message_runtime;car_model")
